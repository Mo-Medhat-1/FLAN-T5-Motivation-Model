...
def load_model():
    ...
    peft_model_id = "./flan_nudge_balanced_best/flan_nudge_balanced_best"
...
st.markdown("**Generate personalized motivational nudges based on your ideas and mood.**")

st.subheader("Your Idea/Task:")
user_idea = st.text_area("Describe what you're working on or thinking about:", "Start working on my graduation project report.", height=100)
...
st.markdown("---")
st.markdown("This project is part of a graduation project showcasing FLAN-T5 fine-tuning with LoRA for personalized motivational text generation. Dataset custom-built from scratch.")
